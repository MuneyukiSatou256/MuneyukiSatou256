...
urlpatterns = [
    ...
    path('diary/list/<int:num>/',views.DiaryListView.as_view(),name="diary_list"),
    ...
    path('diary/register/',views.diary_register.as_view(),name="diary_register"),
    path('diary/Login/',views.Login,name="Login"),
